        ...
        >
          <div
            className={classNames(
              ...
              {
                'w-full left-0': (!showChat || isSmallViewport) && showWorkbench,
                'w-[var(--workbench-inner-width)] left-[var(--workbench-left)]': showChat && !isSmallViewport && showWorkbench,
                'left-[100%] w-[var(--workbench-inner-width)]': !showWorkbench,
              },
            )}
          >
            <div className="absolute inset-0 px-2 lg:px-4">
              <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor shadow-sm rounded-lg overflow-hidden">
                <div className="flex items-center px-3 py-2 border-b border-bolt-elements-borderColor gap-1.5">
                  <button
                    className={classNames(
                      'px-2.5 py-1 rounded-md text-xs font-medium mr-1.5 flex items-center gap-1.5 transition cursor-pointer shadow-xs',
                      !showChat
                        ? 'bg-[#ff7a1a]/20 text-[#ff7a1a] border border-[#ff7a1a]/40 hover:bg-[#ff7a1a]/30'
                    ...
                    title={showChat ? 'Plegar / Colapsar panel de chat' : 'Desplegar / Mostrar panel de chat'}
                  >
                    <div className={classNames('text-base', showChat ? 'i-ph:sidebar-simple' : 'i-ph:sidebar-simple-fill text-[#ff7a1a]')} />
                    {!showChat && <span className="text-[11px] font-semibold text-[#ff7a1a]">Mostrar Chat</span>}
                  </button>
                  ...
                  {selectedView === 'code' && (
                    <div className="flex overflow-y-auto">
                      ...
                      {/* Sync Button */}
                      <div className="flex border border-zinc-200 dark:border-[#2a2a25] rounded-md overflow-hidden ml-1">
                        <DropdownMenu.Root>
                          <DropdownMenu.Trigger
                            disabled={isSyncing || streaming}
                            className="rounded-md items-center justify-center [&:is(:disabled,.disabled)]:cursor-not-allowed [&:is(:disabled,.disabled)]:opacity-60 px-3 py-1.5 text-xs bg-zinc-100 hover:bg-zinc-200 text-zinc-800 dark:bg-[#1a1a17] dark:hover:bg-[#22221e] dark:text-[#f2f0e9] hover:text-[#ff7a1a] dark:hover:text-[#ff7a1a] flex gap-1.5 transition font-medium"
                          >
                      ...
                      <div className="flex border border-zinc-200 dark:border-[#2a2a25] rounded-md overflow-hidden ml-1">
                        <button
                          ...
                          className="rounded-md items-center justify-center [&:is(:disabled,.disabled)]:cursor-not-allowed [&:is(:disabled,.disabled)]:opacity-60 px-3 py-1.5 text-xs bg-zinc-100 hover:bg-zinc-200 text-zinc-800 dark:bg-[#1a1a17] dark:hover:bg-[#22221e] dark:text-[#f2f0e9] hover:text-[#ff7a1a] dark:hover:text-[#ff7a1a] flex gap-1.5 transition font-medium cursor-pointer"
                        >
                  ...
                  <IconButton
                    ...
                    className="-mr-1"
                    size="xl"
                    title="Cerrar / Plegar panel de vista"
                    onClick={() => {
                ...
                <div className="relative flex-1 overflow-hidden">
                  ...
                  <View
                    initial={{ x: '100%' }}
                    animate={{
                      x: selectedView === 'preview' ? '0%' : selectedView === 'database' || selectedView === 'reports' ? '-100%' : '100%',
                    }}
                  >
                  ...
                  <View
                    initial={{ x: '100%' }}
                    animate={{
                      x: selectedView === 'database' ? '0%' : selectedView === 'reports' ? '-100%' : '100%',
                    }}
                  >
                    <DatabaseView />
                  </View>
                  <View
                    initial={{ x: '100%' }}
                    animate={{ x: selectedView === 'reports' ? '0%' : '100%' }}
                  >
                    <ReportsView />
                  </View>
                </div>
