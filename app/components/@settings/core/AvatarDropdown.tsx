...
export const AvatarDropdown = ({ onSelectTab }: AvatarDropdownProps) => {
  ...
  const displayName = saas.isAuthenticated && user?.name ? user.name : (profile?.username || 'Invitado');
    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          >
            <div className="i-ph:gear-six w-4 h-4 text-gray-400 group-hover:text-[#ff7a1a] dark:group-hover:text-[#ff7a1a] transition-colors" />
            Configuración
          </DropdownMenu.Item>
          ...
          <DropdownMenu.Item
            className={classNames(
              'flex items-center gap-2 px-4 py-2.5',
              'text-sm text-gray-700 dark:text-gray-200',
              'hover:bg-orange-50 dark:hover:bg-[#ff7a1a]/10',
              'hover:text-[#ff7a1a] dark:hover:text-[#ff7a1a]',
              'cursor-pointer transition-all duration-200',
              'outline-none',
              'group',
            )}
          ...
          >
            <div className="i-ph:question w-4 h-4 text-gray-400 group-hover:text-[#ff7a1a] dark:group-hover:text-[#ff7a1a] transition-colors" />
            Documentación & Guía
          </DropdownMenu.Item>
        </DropdownMenu.Content>
      </DropdownMenu.Portal>
