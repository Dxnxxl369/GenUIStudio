  ...
  return (
    <button
      className={classNames(
        ...
        type === 'primary'
          ? 'bg-[#ff7a1a] text-[#0a0a09] font-medium hover:bg-[#ff8c3a] dark:bg-[#ff7a1a] dark:text-[#0a0a09] dark:hover:bg-[#ff8c3a]'
          : type === 'secondary'
            ? 'bg-transparent text-zinc-600 dark:text-[#9a988e] hover:bg-zinc-100 dark:hover:bg-[#1a1a17] hover:text-zinc-900 dark:hover:text-[#f2f0e9]'
