...
export type WorkbenchViewType = 'code' | 'diff' | 'preview' | 'database' | 'reports';
...
export class WorkbenchStore {
  ...
  selectedDatabaseTable: WritableAtom<string | undefined> =
    import.meta.hot?.data.selectedDatabaseTable ?? atom<string | undefined>(undefined);
  ...
  constructor() {
    if (import.meta.hot) {
      ...
      import.meta.hot.data.selectedDatabaseTable = this.selectedDatabaseTable;
